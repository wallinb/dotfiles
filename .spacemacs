...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(lua
     ...
     clojure
     (elfeed :variables rmh-elfeed-org-files (list "~/Sync/org/feeds.org"))
     emacs-lisp
     git
     helm
     html
     ...
     (org :variables
          ...
          org-jira-working-dir "~/Sync/org/jira/"
     ...
     rust
     (scheme :variables scheme-implementations '(guile racket chicken))
     (shell :variables
   ...
   dotspacemacs-additional-packages '(org-super-agenda org-edna org-ql org-chef org-ai)
